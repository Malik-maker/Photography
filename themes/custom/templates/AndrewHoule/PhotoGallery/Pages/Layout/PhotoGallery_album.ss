...
<div class="container pb-5 pt-4 pics">
 <article>	
<%-- <h2 class="text-muted gallery">$Title</h2> --%>
<h3 class="photo-album__title" style="padding-bottom: 30px;">$PhotoAlbum.Name</h3>
	...
	<div class="other-albums-wrap">
	  ...
	  <ul class="other-albums">
        ...
        <li class="other-album">
          <a href="$Link" class="other-album__link text-success">$Name</a>
        </li><!-- .other-album -->
	    <% end_loop %>
	  </ul><!-- .other-albums -->
